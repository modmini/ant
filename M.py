...
cl.login(token="Eo2MBBSu4xDlh3jn5wRa.OCTUHf+O8MrV6kxfKrHb/G.nseCjLT4d7cfrsAZh+CVKLk2pDSc2JvJsptkQEBYuLQ=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EoboBmfYNWv7GNq8fYW6.U7Gvr9sujvBq7JF8IAZ7nG.clLMD6nMZ6tWKhxNwfGVx0T8PjO4H4zsYRgBZxOG+Nc=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="Eom0zvGZrgSRmDNPSah2.OQqjB9dJhQErfsVfrONXyG.uapkETwlVl2FT7wpxa6gebzA0lDq2gwk0osQAMJcGZc=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EoNVrJNv8Jj9c6wFWxue.tjCuQHDZ+qlVZNls7BQ6dG.zNIJbwskGfJyUVaoEILxboOVLP/Ora73wZmG54ilkXk=")
kc.loginResult()

kd = LINETCR.LINE()
kd.login(token="EoxwIDG6suxFaC0bMEs0.jIxNXWLPHbxxvm/gsLAeCa.JUJjdlZRd6EPzEJZLoK2Xl8FeDKFXuQY3UDYQZu2u14=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="Eoc8WJ7Askntv3v4Hf33.1WnlDhu8C0fQPatCQsUJmW.ltAG7QWbUdMFDKv8MzMM99h9D1z+era2QJGYpMdzc1Y=")
ke.loginResult()

kf = LINETCR.LINE()
kf.login(token="EoglKodmQyPdzXnlCKy1.LUsP62ucl5oKnK8z95aNGq.Wsid6snk5a1xwfRAHGNN407Av/h9ewQEmxTppUvC6sU=")
kf.loginResult()

kg = LINETCR.LINE()
kg.login(token="Eof2Ch90S4uvztH9Y4Ne.9rt6H24gLX0F7LPllfZzVG.IL0Rn28lOqHIUuGNdf4EJE4Ol6N4gE7+6iB5QC8yoMk=")
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token="EoC6qx4sMqVXjzNxu0Rc.0Ih73wm4pUYMNcYK1nuWFa.QwWlVRCY28+Vs4VoXDjTm3o3UKej3CfgsW6tcJp9WrQ=")
kh.loginResult()

kj = LINETCR.LINE()
kj.login(token="EohP3njzi4p0kvR3pAq6./btZni3nVXWvshGwPQV7PG.cxkpNUdyPgYZWAWycTGmEjOUgRNqsqkuFrwOie+7ROk=")
kj.loginResult()

kl = LINETCR.LINE()
kl.login(token="EoZwaRCWrsIaoIy1xQta.gvkdf5H6cMllyS3Mf6HhAG./P2z1HYjwhLOl2kSWEWss+Brn+PMAdPJOKky7tpFh2U=")
kl.loginResult()

#km = LINETCR.LINE()
#km.login(token="Eoo2cN3njbcRy7dRusZ3.z3/s6DxOmDUtGPTOktVFeW.O+Bm+TbgHIKO1yamM46EuVcNvmi7nO7QdakM6XopofY=")
#km.loginResult()
...
autoleaveroom = []
targets = []
Bots = ["u04ed6417e1922a439e5b25d2d15ed950""ua1cb6e845fe8f2646fe8a5c5911841fa",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid]
self = ["u04ed6417e1922a439e5b25d2d15ed950""ua1cb6e845fe8f2646fe8a5c5911841fa",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid]
                    ...
                    if msg.text is not None:
                        ...
                        if data['status'] == 200:
                            if data['result']['result'] == 100:
                                ki4.sendText(msg.to, "[ ChatBOT ] " + data['result']['response'].encode('utf-8'))
                                
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["[Auto Tag]",cName + " คือออ!!!!เรียกผมหรอครับ\n\n[By.มินทีมทดลองบอท]\n",cName + " หยุดแท็กเหอะ ถ้าสำคัญจริงก็คอลมา\n\n[By.มินทีมทดลองบอท]","เอ่อๆรู้แล้วแท็คอยอยู่ได้\n\n[By.มินทีมทดลองบอท]","ขอร้องเหอะตีป้อมอยู่!!\n\n[By.มินทีมทดลองบอท]\n", cName + " ทำไมต้องแท็ก?แล้วแทคผมทำเพื่อ\n\n[By.มินทีมทดลองบอท]\n" + cName, "ชอบแท็กนักหราา \n\n[By.มินทีมทดลองบอท]\n" + cName, "คุณเป็นใคร?\n\n[By.มินทีมทดลองบอท] \n" + cName + "?", "เห้ออ..\n" + cName + "?","ขาดความอบอุ่นหราาา ","== ww =="]
...
""")
                ...
                kk.sendText(msg.to,"ผมมาอยู่นานแล้ว....แหม่")
                kc.sendText(msg.to,"กูว่ามึงพึ่งมานะ...!!!")
                kd.sendText(msg.to,"ใช่หรอเพื่อนน")
                ke.sendText(msg.to,"กูว่าพวกมึงถามผู้คุมดูนะ")
                kf.sendText(msg.to,"ผู้คุมแม่งเงียบหวะ...")
                kg.sendText(msg.to,"เอ่อๆๆมาก่อนมาหลังไม่สำคัญหรอกหำ")
                kh.sendText(msg.to,"ขอแค่ยึดกลุ่มนี้ได้ก็พอมั้ง")
                kj.sendText(msg.to,"เอ่อนั้นดิป่ะๆยึดแม่งหรือไม่ก็บินแม่ง")
                ...
                md = "•─ ͜͡✫ѕєʟғвот[Min]κɪcκєʀ ͜͡✫─•\n\n"
                if wait["likeOn"] == True: md+="􀜁􀇔􏿿 Auto like : on 􀜁􀄯􏿿\n"
                else:md+="􀜁􀇔􏿿 Auto like : off 􀜁􀄰􏿿\n"
#                if wait["copy"] == True: md+="�� Mimic : on\n"
#                else:md+=" �� Mimic : off\n"
                if wait["winvite"] == False: md+="􀜁􀇔􏿿 Invite : on  􏿿\n"
                else:md+="􀜁􀇔􏿿 Invite : off 􀜁􀄰􏿿\n"
                if wait["pname"] == False: md+="􀜁􀇔􏿿 Namelock : on 􀜁􀄯􏿿\n"
                else:md+="􀜁􀇔􏿿 Namelock : off 􀜁􀄰􏿿\n"
                if wait["contact"] == False: md+="􀜁􀇔􏿿 Contact : on 􀜁􀄯􏿿\n"
                else: md+="􀜁􀇔􏿿 Contact : off 􀜁􀄰􏿿\n"
                if wait["autoJoin"] == False: md+="􀜁􀇔􏿿 Auto join : on 􀜁􀄯􏿿\n"
                else: md +="􀜁􀇔􏿿 Auto join : off 􀜁􀄰􏿿\n"
                if wait["autoCancel"]["on"] == False: md+="􀜁􀇔􏿿 Group cancel :" + str(wait["autoCancel"]["members"]) + " 􀜁􀄯􏿿\n"
                else: md+= "􀜁􀇔􏿿 Group cancel : off 􀜁􀄰􏿿\n"
                if wait["leaveRoom"] == False: md+="􀜁􀇔􏿿 Auto leave : on 􀜁􀄯􏿿\n"
                else: md+="􀜁􀇔􏿿 Auto leave : off 􀜁􀄰􏿿\n"
                if wait["timeline"] == False: md+="􀜁􀇔􏿿 Share : on 􀜁􀄯􏿿\n"
                else:md+="􀜁􀇔􏿿 Share : off 􀜁􀄰􏿿\n"
                if wait["clock"] == False: md+="􀜁􀇔􏿿 Clock Name : on 􀜁􀄯􏿿\n"
                else:md+="􀜁􀇔􏿿 Clock Name : off 􀜁􀄰􏿿\n"
                if wait["autoAdd"] == False: md+="􀜁􀇔􏿿 Auto add : on 􀜁􀄯􏿿\n"
                else:md+="􀜁􀇔􏿿 Auto add : off 􀜁􀄰􏿿\n"
                if wait["commentOn"] == False: md+="􀜁􀇔􏿿 Comment : on 􀜁􀄯􏿿\n"
                else:md+="􀜁􀇔􏿿 Comment : off 􀜁􀄰􏿿\n"
                if wait["Backup"] == False: md+="􀜁􀇔􏿿 Backup : on 􀜁􀄯􏿿\n"
                else:md+="􀜁􀇔􏿿 Backup : off 􀜁􀄰􏿿\n"
                if wait["qr"] == False: md+="􀜁􀇔􏿿 Protect QR : on 􀜁􀄯􏿿\n"
...
#----------------------------------------------------------
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["อย่าแท็กกู กูไม่ว่าง!!",cName + " มีปัญหาอะไร ?!",cName + " หยุดแท็กเหอะ ถ้าสำคัญจริงก็คอลมา","ยังๆ ยังไม่หยุด","ขอร้องเหอะตีป้อมอยู่!!", cName + " ทำไมต้องแท็ก?" + cName, "ชอบแท็กนักหราา " + cName, "คุณเป็นใคร? " + cName + "ครับว่าจังได่", "เห้ออ.." + cName + "?","ขาดความอบอุ่นหราาา ","แทคทมายยยหำ"]
                     ret_ = random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["อย่าแท็กกู กูไม่ว่าง!!",cName + ""]
                     ret_ = random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
...
#=================================================
                    ...
                    cl.sendText(msg.to, "•─ ͜͡✫ѕєʟғвот[Min]κɪcκєʀ ͜͡✫─• (Set time)")
                    try:
                        del wait2['readPoint'][msg.to]
                        del wait2['readMember'][msg.to]
                    except:
...
#========================================
            ...
            elif msg.text in ["บายหำ","บอทออกทุกกลุ่ม"]:
				gid = cl.getGroupIdsJoined()
...
#============================================
                ...
                ke.sendText(msg.to,"•─ ͜͡✫ѕєʟғвот[Min]κɪcκєʀ ͜͡✫─•\n🏂⛷️[จะออกไปแตะขอบฟ้า]")
                ...
                kc.sendText(msg.to,"•─ ͜͡✫ѕєʟғвот[Min]κɪcκєʀ ͜͡✫─•\n🏂⛷️[จะออกไปแตะขอบฟ้า]")
                kd.createGroup("🏃​⌒ ก้าว คนล่ะก้าว", mi_d)
                kd.sendText(msg.to,"•─ ͜͡✫ѕєʟғвот[Mim]κɪcκєʀ ͜͡✫─•\n⛷️🏂[จะออกไปแตะขอบฟ้า]")
                ke.createGroup("🏃​⌒ ก้าว คนล่ะก้าว", mi_d)
                ke.sendText(msg.to,"•─ ͜͡✫ѕєʟғвот[Min]κɪcκєʀ ͜͡✫─•\n🏂⛷️[จะออกไปแตะขอบฟ้า]")
                kf.createGroup("🏃​⌒ ก้าว คนล่ะก้าว", mi_d)
                kf.sendText(msg.to,"•─ ͜͡✫ѕєʟғвот[Min]κɪcκєʀ ͜͡✫─•\n⛷️🏂[จะออกไปแตะขอบฟ้า]")
