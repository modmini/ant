...
cl = LINETCR.LINE()
cl.login(token='EoV0QdNetXw5hr5Iygia.OCTUHf+O8MrV6kxfKrHb/G.fXFMF9XCWShrAIrwTyWOynPZplCaGUncoU4aoyDezZs=')
cl.loginResult()

#ki1 = LINETCR.LINE()
#ki1.login(token='EnXyGnS6WHRH9WGx0Iyd.f41DoffOio7QHS5kSVyVlq.IIpgMuqGfXQ/G5usAh5tgc6ZZSPEptrpACPiXEWxMmA=')
#ki1.loginResult()

#ki2 = LINETCR.LINE()
#ki2.login(token='En7gy6GcsUeyQrn4Y5Q1.OFdc2oVa5NtbpXhRKHafmq.2nX6hbGCyx9csWPIEN1z0h2jnp/ZA2bjRPdKfg808Kk=')
#ki2.loginResult()

#ki3 = LINETCR.LINE()
#ki3.login(token='En1MP3RuqECyOErJhfz1.3F5mAYbgAHDqpBJBma2x0q.Aa+c34koDhRIlVShV/VibVrYHTLk7GlcDbPJ8GHD59g=')
#ki3.loginResult()

#ki4 = LINETCR.LINE()
#ki4.login(token='EnYQ97wCuAXokVayNIX3.g3V1VYdjPTVRkLmEcvSbCW.zRAfIyvmIeVIpjv3gqkLQzj+m0JOZSDb6P2R6ZTEIKY=')
#ki4.loginResult()
...
──┅═✥===========✥═┅──
╔══════════════════
║MIN ♥ ᶜᵒᵐᵐᵃᶰᵈ ᵍʳᵒᵘᵖ ♥MIN
╠══════════════════
║❂➤  Creator 
║❂➤ ยูทูป  ชื่อสิ่งที่ค้นหา
║❂➤  Gn: text 
║❂➤  Invite:on 
║❂➤  Invite: mid 
║❂➤  Allgift 
...
wait = {
    ...
    "lang":"JP",
    "comment":"THIS IS AUTO LIKE BY TEAM TEST BOT",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            pass
                                        ki1.sendText(op.param1,"ล็อคชื่อกลุ่ม")
                                        ki2.sendText(op.param1,"อย่ามาเปลี่ยนเล่นหละ")
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["[Auto Tag]",cName + " คือออ!!!!เรียกผมหรอครับ\n\n[By.มินทีมทดลองบอท]!",cName + " หยุดแท็กเหอะ ถ้าสำคัญจริงก็คอลมา\n\n[By.มินทีมทดลองบอท]","เอ่อๆรู้แล้วแท็คอยอยู่ได้\n\n[By.มินทีมทดลองบอท]","ขอร้องเหอะตีป้อมอยู่!!\n\n[By.มินทีมทดลองบอท]", cName + " ทำไมต้องแท็ก?แล้วแทคผมทำเพื่อ\n\n[By.มินทีมทดลองบอท]" + cName, "ชอบแท็กนักหราา \n\n[By.มินทีมทดลองบอท]" + cName, "คุณเป็นใคร?\n\n[By.มินทีมทดลองบอท] " + cName + "?", "เห้ออ.." + cName + "?","ขาดความอบอุ่นหราาา ","== ww =="]
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                   ...
                   if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        ...
                        wait["dblack"] = False
                        cl.sendText(msg.to,"ผู้ใช้นี้ไม่ได้อยู่ในบัญชีด")
                        
               elif wait["wblacklist"] == True:
                   if msg.contentMetadata["mid"] in wait["blacklist"]:
                        cl.sendText(msg.to,"เสร็จเรียบร้อยแล้ว")

                        wait["wblacklist"] = False
                   else:
                        wait["blacklist"][msg.contentMetadata["mid"]] = True
                        wait["wblacklist"] = False
                        cl.sendText(msg.to,"ดำเนินการเสร็จสิ้นแล้ว")
...
#-----------------------------------------------
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                        ...
                        pass
#-------------------------------------------------
            elif msg.text in ["Ext All on","Ext all on","Satan on#"]:
            ...
            elif msg.text in ["Ext All off","Ext all off","Satan off#"]:
                        cl.sendText(msg.to,"E X T R E M M I S T S Team")
...
#==============================================================================#
            ...
            elif "Min tag all" == msg.text.lower():
                 group = cl.getGroup(msg.to)
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    ...
                                    raise e
            elif "#ExtHA" in msg.text:
                       nk0 = msg.text.replace("#ExtHA","")
                       nk1 = nk0.lstrip()
                       nk2 = nk1.replace("","")
                       nk3 = nk2.rstrip()
                       _name = nk3
...
#==============================================================================#
                ...
                if msg.toType == 2:
                    ...
                    for tag in wait["blacklist"]:
                        matched_list+=filter(lambda str: str == tag, gMembMids)
                    if matched_list == []:
                        kk.sendText(msg.to,"ไม่มีรายการแบล็กลิสต์")
                        return
                    for jj in matched_list:
                        try:
...
# ----------------- BAN MEMBER BY TAG 2TAG ATAU 10TAG MEMBER
       ...
       #-------------Fungsi Respon Start---------------------#
                ...
                cl.sendText(msg.to,X)
                  ...
                  try:
                      ...
                      cl.sendText(msg.to, pesan)
                          ...
                          try:
                              pesan="ข้อความยาวเกินไปโปรดคลิกลิงก์ด้านล่าง\n"
                              pesan+=wikipedia.page(wiki).url
                              cl.sendText(msg.to, pesan)
                          except Exception as e:
                              cl.sendText(msg.to, str(e))
        ...
        if op.type == 25:
            msg = op.message
            if msg.text.lower() in ["Ext Tagall"]:
                group = cl.getGroup(msg.to)
                nama = [contact.mid for contact in group.members]
                nm1, nm2, nm3, nm4, nm5, jml = [], [], [], [], [], len(nama)
                if jml <= 100:
