...
ki2 = LINETCR.LINE()
ki2.login(token="Eom0zvGZrgSRmDNPSah2.OQqjB9dJhQErfsVfrONXyG.uapkETwlVl2FT7wpxa6gebzA0lDq2gwk0osQAMJcGZc=")
ki3 = LINETCR.LINE()
ki3.login(token="EoNVrJNv8Jj9c6wFWxue.tjCuQHDZ+qlVZNls7BQ6dG.zNIJbwskGfJyUVaoEILxboOVLP/Ora73wZmG54ilkXk=")
ki4 = LINETCR.LINE()
ki4.login(token="EoxwIDG6suxFaC0bMEs0.jIxNXWLPHbxxvm/gsLAeCa.JUJjdlZRd6EPzEJZLoK2Xl8FeDKFXuQY3UDYQZu2u14=")
ki5 = LINETCR.LINE()
ki5.login(token="Eoc8WJ7Askntv3v4Hf33.1WnlDhu8C0fQPatCQsUJmW.ltAG7QWbUdMFDKv8MzMM99h9D1z+era2QJGYpMdzc1Y=")
ki6 = LINETCR.LINE()
ki6.login(token="EoglKodmQyPdzXnlCKy1.LUsP62ucl5oKnK8z95aNGq.Wsid6snk5a1xwfRAHGNN407Av/h9ewQEmxTppUvC6sU=")
ki7 = LINETCR.LINE()
ki7.login(token="Eof2Ch90S4uvztH9Y4Ne.9rt6H24gLX0F7LPllfZzVG.IL0Rn28lOqHIUuGNdf4EJE4Ol6N4gE7+6iB5QC8yoMk=")
ki8 = LINETCR.LINE()
ki8.login(token="EoC6qx4sMqVXjzNxu0Rc.0Ih73wm4pUYMNcYK1nuWFa.QwWlVRCY28+Vs4VoXDjTm3o3UKej3CfgsW6tcJp9WrQ=")
ki9 = LINETCR.LINE()
ki9.login(token="EohP3njzi4p0kvR3pAq6./btZni3nVXWvshGwPQV7PG.cxkpNUdyPgYZWAWycTGmEjOUgRNqsqkuFrwOie+7ROk=")
k1 = LINETCR.LINE()
k1.login(token="EoZwaRCWrsIaoIy1xQta.gvkdf5H6cMllyS3Mf6HhAG./P2z1HYjwhLOl2kSWEWss+Brn+PMAdPJOKky7tpFh2U=")
#k2 = LINETCR.LINE()
...
helpMessage =""" ====[Self Bots MIN HECK BOT]====
...
KAC=[cl,ki,ki2,ki3,ki4,ki5,ki6,ki7,ki8,ki9,k1]
...
Bots = ["ua1cb6e845fe8f2646fe8a5c5911841fa",mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,ki8mid,ki9mid,k1mid]
...
wait = {
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"[SELFBOT MIN HACK BOT]\n\nมีอะไรก็ทิ้งข้อความไว้เลยนะครับ",
    "lang":"JP",
...
#-----------------------------------------------
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = [cName + "เรียกผมหรอคราฟ\nแล้วจะเรียกทมาย\n\n[By.มินทีมทดบองบอท] ", cName + "ครับคร้บรู้แล้วกำลังมาอ่าน\n\n[By.มินทีมทดบองบอท] " + cName + "เอิ่ม", "ถามจริงๆเถอะคือว่างมากป่ะ\n\n[By.มินทีมทดบองบอท] " + cName + "กำแทคกระผมเพื่อ..!!\n\n[By.มินทีมทดบองบอท] ", "เอาละๆหยุดได้แล้ว\n\n[By.มินทีมทดบองบอท] ", "Dont Tag Me!\n\n[By.มินทีมทดบองบอท] ", cName + "ครับว่าไงครับมีปัญหาอะไรส่วนตัวเลยนะครับ\n\n[By.มินทีมทดบองบอท] "]
                     ret_ = "[Auto Respond]\n" + random.choice(balas)
...
#----------------------------------------------------------
                ...
                k1.sendText(msg.to,"[By.มินทีมทดลองบอท]")
...
#-----------------------------------------------
            elif msg.text.lower() == ["Botjoin ps1","หำ","Go go"]:
                        G = cl.getGroup(msg.to)
                        ginfo = cl.getGroup(msg.to)
                        G.preventJoinByTicket = False
                        cl.updateGroup(G)
